...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private var note: com.example.mynoteapps.database.Note? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (note != null) {
            ...
            note = com.example.mynoteapps.database.Note()
        }
        ...
        binding?.btnSubmit?.setOnClickListener {
            ...
            when {
                ...
                description.isEmpty() -> {
                    ...
                    if (isEdit){
                        noteAddUpdateViewModel.update(note as com.example.mynoteapps.database.Note)
                        showToast(getString(R.string.changed))
                    } else {
                        note.let { note ->
                            note?.date = DataHelper.getCurrentDate()
                        }
                        noteAddUpdateViewModel.insert(note as com.example.mynoteapps.database.Note)
    ...
    private fun showAlertDialog(type: Int){
        ...
        with(alertDialogBuilder){
            ...
            setPositiveButton(getString(R.string.yes)){_, _ ->
                if (!isDialogClose){
                    noteAddUpdateViewModel.delete(note as com.example.mynoteapps.database.Note)
